...
choco install -y git googlechrome dotnetfx dotnetcore 7zip docker-desktop kubernetes-helm kubernetes-cli minikube notepadplusplus jre8 vlc python putty.install sysinternals vagrant packer terraform
